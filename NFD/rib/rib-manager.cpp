...
{
  std::cout<< "Listening on: " << commandPrefix <<std::endl;
...
std::cout << "44444444444444 INSIDE: RibManager::registerEntry" << std::endl;
...
RibManager::validateParameters(const ControlCommand& command,
                               ControlParameters& parameters)
{
	std::cout << "555555555555555555555 INSIDE: RibManager::validateParameters" << std::endl;
  try {
