...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.5]{chapter-3/ndnSIMcomponentAbstraction}
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.5]{chapter-3/CommunicationLayerAbstraction}
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.58]{chapter-3/PITdataStructure}
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.6]{chapter-3/FIBdataStructure}
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.5]{chapter-3/Simulation}
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.5]{chapter-3/PITandFIBvis}
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.47]{chapter-3/PipelinesAndStrategies}
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.6]{chapter-3/IncomingInterestPipeline}
  \caption{Pipelines and Strategies, white boxes are decision points inside the strategy while blue boxes represent the different pipelines \cite{Afanasyev16}}
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.63]{chapter-3/OutgoingInterestPipeline}
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.65]{chapter-3/IncomingDataPipeline}
